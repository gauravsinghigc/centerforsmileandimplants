...
<head>
    ...
    <title><?php echo $title;?> : Testimonals</title>
    <link rel="icon" type="image/png" sizes="32x32" href="../images/favicon/favicon-32x32.png">
    <link rel="manifest" href="../images/favicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="<?php echo $url;?>/images/favicon/favicon-32x32.png">
...
<body>
    ...
    <div class="page-wrapper">
        ...
        <section class="inner-banner">
            <div class="container">
                <h2 class="inner-banner__title">Testimonals</h2><!-- /.inner-banner__title -->
                <ul class="thm-breadcrumb">
                    <li class="thm-breadcrumb__item"><a class="thm-breadcrumb__link" href="../">Home</a></li>
                    <li class="thm-breadcrumb__item current"><a class="thm-breadcrumb__link" href="../testimonial">Testimonals</a></li>
                </ul><!-- /.thm-breadcrumb -->
            </div><!-- /.container -->
        ...
        <section class="gallery-one gallery-one__page">
            <div class="container">
                <div class="block-title text-left">
                    <p class="block-title__text">Welcome to <?php echo $name;?>! Our team is dedicated to making every patient feel welcome, comfortable, and valued – because in our office you are! One of our favorite things to do is help those patients who suffer from dental fear or anxiety. </p><!-- /.block-title__text -->
                </div><!-- /.block-title -->
               <div class="row">
                    ...
                    <div class="col-lg-3">
                        <div class="gallery-one__single">
                            <div class="gallery-one__image">
                                <img src="<?php echo $url;?>/img/test/denture 1/20200206_172239.jpg" alt="<?php echo $name;?>"/>
                            </div><!-- /.gallery-one__image -->
                            <div class="gallery-one__content">
                                <a href="<?php echo $url;?>/img/test/" class="gallery-one__popup img-popup"><i class="icon icon-Search"></i></a>
                    ...
                    <div class="col-lg-5">
                        <div class="gallery-one__single">
                            <div class="gallery-one__image">
                                <img src="<?php echo $url;?>/img/test/nigerian testimonial.JPG" alt="<?php echo $name;?>"/>
                            </div><!-- /.gallery-one__image -->
                            <div class="gallery-one__content">
                                <a href="<?php echo $url;?>/img/test/nigerian testimonial.JPG" class="gallery-one__popup img-popup"><i class="icon icon-Search"></i></a>
                            </div><!-- /.gallery-one__content -->
                        </div><!-- /.gallery-one__single -->
                    </div><!-- /.col-lg-4 -->
