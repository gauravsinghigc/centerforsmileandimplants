              ...
              <form action="<?php echo DOMAIN; ?>/controller/specialitycontroller.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                  <div class="form-group col-md-6">
                    ...
                    <input type="text" value="" name="SpecialityName" class="form-control-2" required="">
                  </div>
                  <div class="form-group col-md-6">
                    <label>Status</label>
                  ...
                  <?php UploadImageInput("SpecialityImage", "SpecialityImage", "images/*", true, "form-group col-md-12"); ?>
                  <div class="form-group col-md-12">
                    <label>Speciality Descriptions</label>
                    <textarea class="form-control-2" name="SpecialityDescriptions" rows="5" id="editor" style="height:auto !important;"></textarea>
                  </div>
                  <div class="col-md-12 m-t-15">
                    <button type="submit" name="CreateNewSpeciality" class="btn btn-lg app-bg">Create Speciality</button>
