                ...
                <div class="col-md-8 col-lg-8 col-sm-7 col-12">
                  <form class="form row" action="../../controller/configcontroller.php" method="POST">
                    ...
                    <div class="form-group col-md-12">
                      ...
                      <textarea style="height: 100% !important;" class="form-control-2" name="SHORT_DESCRIPTION" required="" rows="6"><?php echo SECURE(SHORT_DESCRIPTION, "d"); ?></textarea>
                    </div>
                    <div class="form-group col-md-12">
                      <label>Complete Address (Primary)</label>
                      <textarea style="height: 100% !important;" class="form-control-2" name="PRIMARY_ADDRESS" required="" rows="6"><?php echo SECURE(PRIMARY_ADDRESS, 'd'); ?></textarea>
                    </div>
                    <div class="form-group col-md-12">
                      <label>Map Location Url</label>
                      <textarea type="url" style="height: 100% !important;" class="form-control-2" name="PRIMARY_MAP_LOCATION_LINK" required="" rows="6"><?php echo SECURE(PRIMARY_MAP_LOCATION_LINK, 'd'); ?></textarea>
                    </div>
                    <div class="col-md-12">
                      <button type="Submit" name="UpdatePrimaryConfigurations" class="btn btn-md app-bg">Update Details</button>
                    </div>
                  </form>
                </div>
